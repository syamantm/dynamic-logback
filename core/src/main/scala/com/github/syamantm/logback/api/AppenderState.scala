...
/**
  *
  * @param externalSourceTimeout a timeout in timeUnit, after which external sources request will timeout
  ...
  */
case class ScheduleConfig(externalSourceTimeout: Long,
                          initialDelay: Long = 1,
                          interval: Long = 5,
